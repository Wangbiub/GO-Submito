...
print(df)
#%%
df = joblib.load('simcode424.JL')

tag = np.loadtxt('data424.csv', dtype=object, delimiter=',', converters={3: protein_type}, skiprows=1)[:, 3]
